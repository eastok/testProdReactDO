...
// 자식 컴포넌트이고, 부모 컴포넌트로부터, 데이터를 받아와서 받은 데이터를 출력하는 형태
    ...
    <NewsItemCss>
      ...
      {urlToImage && (
        <div className="thumbnail">
          {/* 링크 클릭시 target="_blank" : 새창으로 열기 */}
          {/* rel="noopenr noreferrer" : 새창으로 열었을 때,
          원본 링크의 참조라던지, 개인 정보 부분을 막아주기. */}
