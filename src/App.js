...
import TestZone2 from "./ch12-immerTest/TestZone2";
  ...
  return (
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="AverageUseRefTest" element={<AverageUseRefTest />} />
        {/* useParams test 설정2 */}
        <Route path="UseParamsTest/:id" element={<AverageUseParamsTest8 />} />
        <Route path="CustomHooks" element={<InfoTestCustomHooks9 />} />
        ...
        <Route path="APITestDO" element={<MainRes />} />
      </Routes>
    </BrowserRouter>
  );
}
