    ...
    <Wrapper>
      <div>
        ...
        <Container>
          ...
          <br />
          <Button
            title="RefPracticeScrollTest 이동"
            type="primary"
            onClick={() => {
              navigate("/scrollRefTest");
            }}
          >
            RefPracticeScrollTest 이동
          </Button>
          <br />
          <Button
          ...
          <br />
          <Button
            title="AverageUseRefTest 테스트 "
            type="primary"
            onClick={() => {
              navigate("/AverageUseRefTest");
            }}
          >
            AverageUseRefTest 테스트
          </Button>
          <br />
          <Button
            title="AverageUseParamsTest8 테스트 "
            type="primary"
            onClick={() => {
